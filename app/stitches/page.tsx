...
export const metadata = { title: "Stitches · Sewing School" };
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      ...
      <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <ProjectCard href="/stitches/straight" title="Straight stitch" difficulty="Foundational" time="2 min read" swatch="#faf6ee" />
        <ProjectCard href="/stitches/zigzag" title="Zigzag" difficulty="Beginner" time="3 min read" swatch="#faf6ee" />
        <ProjectCard href="/stitches/buttonhole" title="Buttonhole" difficulty="Intermediate" time="4 min read" swatch="#faf6ee" />
